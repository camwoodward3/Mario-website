...
def process_metroid_data(file_path='metroid.json'):
  ...
  for character_key, character_data in metroid_data.items():
    if not isinstance(character_data, dict):
      continue

    # Extract and normalize character types
    ...
    # Calculate total games directly without sub-threads or barriers
    total_games = sum(
  ...
  # Sort results by total_games descending
