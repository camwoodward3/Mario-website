...
ALLOWED_TYPES = {'protagonist', 'deuteragonist', 'anti-hero', 'supporting character', 'tritagonist', 'antagonist'}
GAME_CATEGORIES = ('main', 'racing', 'sports', 'arcade', 'education', 'cafe', 'smash', 'shows', 'movies', 'other', 'compilations', 'crossovers')

def process_sonic_data(file_path='characters.json'):
  start_time = time.perf_counter()

  try:
    with open(file_path, 'r') as file:
      sonic_data = json.load(file)
  ...
  for character_key, character_data in sonic_data.items():
